...
const routes = [
  ...
  },
  {
    ...
    from: 'Manila',
    to: 'Baguio',
    carrier: 'Northline Transport',
    vehicle: '6-wheel truck',
    capacity: 1500,
    price: 1450,
    duration: '5–6 hours',
    schedule: 'Daily',
  },
  {
    ...
    from: 'Cebu',
    to: 'Davao',
    carrier: 'Island Link Cargo',
    vehicle: 'RoRo cargo truck',
    capacity: 2000,
    price: 2200,
    duration: '2–3 days',
